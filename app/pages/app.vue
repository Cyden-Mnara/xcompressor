...
const desktopRuntime = ref<boolean | null>(null)
...
<template>
  <main
    v-if="desktopRuntime === false"
    class="min-h-screen text-stone-100"
  >
    <div class="mx-auto flex min-h-screen w-full max-w-4xl flex-col justify-center px-4 py-8 lg:px-6">
      <section class="rounded-lg border border-white/10 bg-stone-950/85 p-6 shadow-2xl">
        ...
        <div class="mt-6 flex flex-wrap gap-3">
          <UButton
            to="https://github.com/Cyden-Mnara/xcompressor/releases"
            target="_blank"
